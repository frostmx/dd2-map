...
| [calibration-and-follow.md](findings/calibration-and-follow.md) | The world affine and Refine, the locked-centre follow loop, and heading-up rotation. | world affine, least-squares fit, `calibration.points`, accumulating Refine, drift, `calibrationQuality`, `followFrame`, locked-centre follow, `_fadeDuration`, icon flicker, `rotateWithHeading`, bearing, `__dd2_heading__` |
