// Collected Golden Trove Beetles, read live from app.GimmickManager — the second AR
// collectible after Seeker's Tokens. Beetles do NOT live in the token HashSet
// (app.GenerateManager._NeverGenetateID); their collected-state is per-gimmick, found
// only for beetles currently streamed in near the player. That's fine for the AR layer,
// which is radius-limited anyway.
//
